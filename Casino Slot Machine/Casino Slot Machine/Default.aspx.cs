...
namespace Casino_Slot_Machine
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            Image1.ImageUrl = "/Models/Images/" + reels[0] + ".png";
            Image2.ImageUrl = "/Models/Images/" + reels[1] + ".png";
            Image3.ImageUrl = "/Models/Images/" + reels[2] + ".png";
        }
