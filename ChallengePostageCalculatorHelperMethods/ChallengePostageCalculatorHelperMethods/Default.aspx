...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:RadioButton ID="groundRadioButton" runat="server" AutoPostBack="True" GroupName="fromGroup" OnCheckedChanged="handleChange" Text="Ground" />
            <br />
            <asp:RadioButton ID="airRadioButton" runat="server" AutoPostBack="True" GroupName="fromGroup" OnCheckedChanged="handleChange" Text="Air" />
            <br />
            <asp:RadioButton ID="nextDayRadioButton" runat="server" AutoPostBack="True" OnCheckedChanged="handleChange" Text="Next Day" />
            <br />
            <br />
